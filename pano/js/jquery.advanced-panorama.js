	...
	$.fn.panorama = function(options) {
		this.each(function(){ 
			...
			panoramaContainer.css('height', elemHeight+'px').css('overflow', 'hidden').wrap("<div class='panorama-viewport'></div>").parent().css('width',settings.viewport_width+'px')
				.append("<div class='panorama-control'><a title='סובב שמאלה' class='panorama-control-left'><<</a> <a title='חזור למפה' class='panorama-control-pause'>X</a> <a title='סובב ימינה' class='panorama-control-right'>>></a> </div>");
