	...
	$.fn.panorama = function(options) {
		this.each(function(){ 
			...
			panoramaContainer.css('height', elemHeight+'px').css('overflow', 'hidden').wrap("<div class='panorama-viewport'></div>").parent().css('width',settings.viewport_width+'px')
				.append("<div class='panorama-control'><a href='#' title='סובב שמאלה' class='panorama-control-left'><<</a> <a href='#' title='חזור למפה' class='panorama-control-pause'>X</a> <a href='#' title='סובב ימינה' class='panorama-control-right'>>></a> </div>");
			...
			panoramaViewport.find('a.panorama-control-pause').bind('click', function() {
				$(panoramaContainer).stop();
				//location.reload();/*refresh all site*/
				$('#ajax1').empty();
