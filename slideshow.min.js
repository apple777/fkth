...
function slideshow(slideshowname){this.name=slideshowname;this.repeat=false;this.prefetch=-1;this.image;this.textid;this.textarea;this.timeout=100;this.slides=new Array();this.current=0;this.timeoutid=0;this.add_slide=function(slide){var i=this.slides.length;if(this.prefetch==-1){slide.load();}
this.slides[i]=slide;}
