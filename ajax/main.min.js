...
$.fn.jScrollPane.defaults={scrollbarWidth:10,scrollbarMargin:5,wheelSpeed:18,showArrows:false,arrowSize:0,animateTo:false,dragMinHeight:1,dragMaxHeight:99999,animateInterval:100,animateStep:3,maintainPosition:true,scrollbarOnLeft:false,reinitialiseOnImageLoad:false,tabIndex:0,enableKeyboardNavigation:true,animateToInternalLinks:false,topCapHeight:0,bottomCapHeight:0,observeHash:true};$(window).bind('unload',function(){var els=$.jScrollPane.active;for(var i=0;i<els.length;i++){els[i].scrollTo=els[i].scrollBy=null;}});})(jQuery);function titleSwitch(elementThis){switch($(elementThis).attr('id')){case'title_hertzberg':if($(elementThis).hasClass('name')){$(elementThis).html('1827 – 1897');}
else{$(elementThis).html('זאב הרצברג');}
$(elementThis).toggleClass('name');break;case'title_frumkin':if($(elementThis).hasClass('name')){$(elementThis).html('1851 – 1914');}
else{$(elementThis).html('ישראל דב פרומקין');}
$(elementThis).toggleClass('name');break;case'title_eliezer':if($(elementThis).hasClass('name')){$(elementThis).html('1858 – 1922');}
else{$(elementThis).html('אליעזר בן-יהודה');}
$(elementThis).toggleClass('name');break;case'title_kook':if($(elementThis).hasClass('name')){$(elementThis).html('1865 – 1935');}
else{$(elementThis).html('הרב אברהם קוק');}
$(elementThis).toggleClass('name');break;case'title_meyuchas':if($(elementThis).hasClass('name')){$(elementThis).html('1868 – 1942');}
else{$(elementThis).html('יוסף מיוחס');}
$(elementThis).toggleClass('name');break;case'title_mordechai_halevy':if($(elementThis).hasClass('name')){$(elementThis).html('1875 – 1947');}
else{$(elementThis).html('הרב מורדכי הלוי');}
$(elementThis).toggleClass('name');break;case'title_harav_uziel':if($(elementThis).hasClass('name')){$(elementThis).html('1880 – 1953');}
else{$(elementThis).html('הרב עוזיאל');}
$(elementThis).toggleClass('name');break;case'title_itamar_leah':if($(elementThis).hasClass('name')){$(elementThis).html('1882 – 1943');}
else{$(elementThis).html('לאה ואיתמר');}
$(elementThis).toggleClass('name');break;case'title_albert_ticho':if($(elementThis).hasClass('name')){$(elementThis).html('1883 – 1960');}
else{$(elementThis).html('אלברט ואנה טיכו');}
$(elementThis).toggleClass('name');break;case'title_nissim_levy':if($(elementThis).hasClass('name')){$(elementThis).html('1888 – 1971');}
else{$(elementThis).html('ניסים לוי');}
$(elementThis).toggleClass('name');break;case'title_mordechai_eliash':if($(elementThis).hasClass('name')){$(elementThis).html('1892 – 1950');}
else{$(elementThis).html('מרדכי אליאש');}
$(elementThis).toggleClass('name');break;case'title_gershon_agron':if($(elementThis).hasClass('name')){$(elementThis).html('1894 – 1959');}
else{$(elementThis).html('גרשון אגרון');}
$(elementThis).toggleClass('name');break;case'title_glick_family':if($(elementThis).hasClass('name')){$(elementThis).html('1897');}
else{$(elementThis).html('משפחת גליק');}
$(elementThis).toggleClass('name');break;case'title_institute_blind':if($(elementThis).hasClass('name')){$(elementThis).html('1902 – 1910');}
else{$(elementThis).html('בית חינוך עיוורים');}
$(elementThis).toggleClass('name');break;case'title_dailymail':if($(elementThis).hasClass('name')){$(elementThis).html('1919 – 1936');}
else{$(elementThis).html('"דואר היום"');}
$(elementThis).toggleClass('name');break;case'title_alba_pharmacy':if($(elementThis).hasClass('name')){$(elementThis).html('1924');}
else{$(elementThis).html('בית מרקחת אלבא');}
$(elementThis).toggleClass('name');break;}}
$(document).ready(function(){$('#timeline').mousedown(function(event){$(this).data('down',true).data('x',event.clientX).data('scrollLeft',this.scrollLeft);return false;}).mouseup(function(event){$(this).data('down',false);}).mousemove(function(event){if($(this).data('down')==true){this.scrollLeft=$(this).data('scrollLeft')+$(this).data('x')-event.clientX;}}).mousewheel(function(event,delta){var currentPosition=$('#timeline').css("background-position");currentPosition=currentPosition.split('px');currentPosition=Number(currentPosition[0]);if(currentPosition<0){currentPosition=0}
if(currentPosition>1200){currentPosition=1200}
$('#timeline').css("background-position",((delta*50)+currentPosition)+"px 0px");this.scrollLeft-=(delta*50);}).css({'overflow':'hidden','cursor':'-moz-grab','opacity':'0.8'});$('#timeline h3').hover(function(){window.setTimeout(titleSwitch,600,[this]);});$('.tl-events img').hover(function(){$(this).fadeTo(250,1);},function(){$(this).fadeTo(250,0.8);});});$(window).mouseout(function(event){if($('#timeline').data('down')){try{if(event.originalTarget.nodeName=='BODY'||event.originalTarget.nodeName=='HTML'){$('#timeline').data('down',false);}}catch(e){}}});$(document).ready(function(){var playItem=0;var myPlayList=[{name:"לאהוב בחורה אחת - כוכבה לוי",mp3:"jquery.jplayer/cd/5.mp3",ogg:"jquery.jplayer/cd/5.ogg"},{name:"חושו אחים חושו - מקהלת צדיקוב",mp3:"jquery.jplayer/cd/1.mp3",ogg:"jquery.jplayer/cd/1.ogg"},{name:"עצים בוכים לגשם - יצחק לוי",mp3:"jquery.jplayer/cd/2.mp3",ogg:"jquery.jplayer/cd/2.ogg"},{name:"על הירדן - שמעון ישראלי",mp3:"jquery.jplayer/cd/3.mp3",ogg:"jquery.jplayer/cd/3.ogg"},{name:"קולי שמע וראה דמע - זלמן ריבלין",mp3:"jquery.jplayer/cd/4.mp3",ogg:"jquery.jplayer/cd/4.ogg"},{name:"אדון הסליחות - יוסי בנאי והמקלה",mp3:"jquery.jplayer/cd/6.mp3",ogg:"jquery.jplayer/cd/6.ogg"},{name:"יגדל אלוהים חי - יהורם גאון והמקלה",mp3:"jquery.jplayer/cd/7.mp3",ogg:"jquery.jplayer/cd/7.ogg"},{name:"שמע קולנו - זלמן ריבלין והמקלה",mp3:"jquery.jplayer/cd/8.mp3",ogg:"jquery.jplayer/cd/8.ogg"}];var jpTimeLeft=$("#jplayer_time_remain");$("#jquery_jplayer").jPlayer({ready:function(){displayPlayList();playListInit(true);},oggSupport:true}).jPlayer("onProgressChange",function(loadPercent,playedPercentRelative,playedPercentAbsolute,playedTime,totalTime,timeLeft){timeLeft=totalTime-playedTime;jpTimeLeft.text("-"+$.jPlayer.convertTime(timeLeft));}).jPlayer("onSoundComplete",function(){playListNext();});$("#jplayer_previous").click(function(){playListPrev();$(this).blur();return false;});$("#jplayer_next").click(function(){playListNext();$(this).blur();return false;});function displayPlayList(){$("#jplayer_playlist ul").empty();for(i=0;i<myPlayList.length;i++){var listItem=(i==myPlayList.length-1)?"<li class='jplayer_playlist_item_last'>":"<li>";listItem+="<a id='jplayer_playlist_item_"+i+"' tabindex='1'>"+myPlayList[i].name+"</a></li>";$("#jplayer_playlist ul").append(listItem);$("#jplayer_playlist_item_"+i).data("index",i).click(function(){var index=$(this).data("index");if(playItem!=index){playListChange(index);}else{$("#jquery_jplayer").jPlayer("play");}
$(this).blur();return false;});}}
function playListInit(autoplay){if(autoplay){playListChange(playItem);}else{playListConfig(playItem);}}
function playListConfig(index){$("#jplayer_title_track").text(myPlayList[playItem].name);playItem=index;$("#jquery_jplayer").jPlayer("setFile",myPlayList[playItem].mp3,myPlayList[playItem].ogg);}
