...
<small>מאמר של ב. מיכאל מעיתון בידיעות אחרונות בתאריך 08/08/2009</small>
<br/>
<br/>

<div class="stone_name">
<h4>מושפלת עד שאול</h4>
</div>


<p>
ביום חמישי, כ"ח בתמוז, 31 ביולי, למחרת יום הולדתו של לב לבייב ובעיצומם של ימי בין המצרים, החלה התכונה. בשעות אחר הצהריים הגיע הדחפור האדום, מלתעותיו לטושות, זרועו מונפת, והמתין להוראות מפעיליו.
</p><p>
לפנות ערב ניתנה ההוראה. הזרוע התנפנפה, המלתעות נגסו, ותוך שעתיים לא נותר אלא תל של חרבות מן הבית שעמד במאה השנים האחרונות ברחוב הרב קוק 7, בעיבורה של ירושלים.
</p><p>
היש מועד נאה יותר להמטת חורבן על העיר, מאשר ימי בין המצרים שבין י"ז בתמוז ותשעה באב?
</p><p>
היש מתנה נאה יותר ליום הולדתו של לב לבייב, האיש שמאחורי החברה ההורסת, מאשר גל אבנים חרבות שעליהן יבנה עוד מפלצת כעורה ונובורישית? עוד כמה ערי מסכנות לדיירי-ארעי מליונרים?
</p><p>
זה היה עוד פיגוע דחפור בעיר האומללה הזאת. פגוע ברשות ובסמכות. ברוך השם ללא פגיעות בנפש, אך עם פגיעה כואבת בנשמתה.
</p><p>
"בית היתומים האשכנזי" היה שמו הראשון של הבית. יש שכינוהו "בית היתומים של הרצברג", על שם מנהלו, ד"ר זאב וילהלם הרצברג, ממחיי השפה העברית, ממייסדי הספריה הלאומית, מחנך, סופר ואיש נשכח. גם בית הספר "למל" שכן שם, ואחר כך בית ספר עירוני. עד יומו האחרון עיטר שלט אבן יפהפה את הכניסה, ועליו חקוקות המילים הגאות: "בית הספר העירוני לבנים". אפילו לוח האבן הזה נגרס עד דק תחת פרסותיו של הבולדוזר.
</p><p>
מאוחר יותר נעשה הבית ל"בית ספר סוקולב", ובשנותיו האחרונות שכן בו בית הספר "אנקורי".
</p><p>
מאה שנים של מיצהלות תלמידים באו אל קצן בכ"ח בתמוז תשס"ח. בית הדור, מכובד, יפה, בית שהיה מסומן במשך שנים כבית לשימור, היה לעיים.
</p><p>
עוד תו מתווי פניה הטובים של ירושלים הנכחדת נמחה מעל פני האדמה. עוד צעד אחד, די גדול, בהחרבת מלוא מתחם רחוב הנביאים- הרחוב היפה ביותר, החשוב ביותר וההסטורי ביותר בירושלים המערבית- והפיכתו ל"נתיב תחבורה ראשי".
</p><p>
במקום בית הספר תוקם כאן (על פי ההדמיות באתר הקבלן) עוד זוועה אורבנית, מכוערת כמדוזה מן המיתולוגיה. מגדלי דירות עתירי ג'קוזים לגבירים מרובי ממון,אשר יסורו לכאן פעמיים בשנה- פעם כדי לתקוע בשופר ופעם כדי לשרוף חמץ- ויגיפו את התריסים בכל שאר ימות השנה.
</p><p>
סלאם רפאים מהודר ונפוח, שכל תכליתו להניב רווחי עתק ליזמים ערלי-לב וארנונת עתק לעירייה ערלת-נפש.  
</p><p>
כי זו, זו בלבד, היא העילה שמאחורי נכונות העירייה לאשר שוב ושוב מעשי תועבה שכאלה: הרצון לכושש עוד ועוד ארנונה, כדי להמשיך ולתחזק את טפיליה המתרבים של העיר המרודה הזו.
</p><p>
לב לבייב, האוליגרך ששלוחותיו ממיטות את החורבן על מתחם הנביאים (לא לבד), היגר לא מזמן ללונדון. משם, מתוך הארמון מנקר העיניים שקנה לעצמו הוא מטיף לנו מוסר. לא מעט בוז ולעג יש בפיו על תרבותה ויהודיה החילונים של ישראל.
</p><p>
והוא צודק. כי לא לבייב אשם בחורבן, ואפילו לא העירייה, אלא רק עדר הכבשים החילוני, המסכים שוב ושוב, ברפיסות ובאדישות כנועות, להמשיך ולשאת את העיר הזאת על עמל כפיו, על כתפיו ועל כיסו.
</p><p>
ביום שישי , למחרת החורבן, לא נותר במקום אלא בדל אחד אחרון של קיר הכניסה. ביום ראשון נעלם גם הוא. עוד מעט-קט יגיע תורם של העצים המצלים על רחוב קוק. אין ספק, גם עליהם יעלה הכורת. הלא הם אינם "נכסים מניבים". וגם יומה של גדר האבן הזקנה יגיע. בתוך אחת מאבניה הקשישות נטועה עדיין קופת צדקה קטנה ועליה שלט נחושת. חרוט בו המכתם המוכר ומלא הכתיבה: "צדקה תציל ממוות".
</p><p>
הרבה צדקה עשה הבית הזה בכל שנותיו. היא לא הצילה אותו ממוות. עוד מעט תיעקר גם הקופה, תושלך לזבל ותפנה את מקומה ל"דורמן" שישמור על ה"לובי", וידאג שרק היפים והעשירים יוכלו להגיע אל ה"פטיו" ואל ה"ספא".
</p><p>
והבטן ממש מתהפכת.
</p>
	...
	<audio controls="controls" autoplay="autoplay">
		<source src="ajax/voiceover/moshelet_ad_sheaol_good.ogg" type="audio/ogg" />
		<source src="ajax/voiceover/moshelet_ad_sheaol_good.mp3" type="audio/mpeg" />
		Your browser does not support the audio element.
	</audio>
</div>
-->			
...
<!--		
<div class="stone" dir="ltr">
<video width="633" height="351" controls="controls">
  <source src="video/destroy_boys_school.mp4" type="video/mp4" />
  <source src="video/destroy_boys_school.ogv" type="video/ogg" />
